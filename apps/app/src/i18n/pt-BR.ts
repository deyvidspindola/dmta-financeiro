...
export const strings = {
  ...
  imports: {
    ...
    listTitle: 'Importar dados',
    listHint: 'Escolha o tipo de importação',
    billsTitle: 'Importar boletos',
    ...
    cardInvoiceDescription:
      'Parcelas N/M com N>1 só anotam na descrição. Reimportar faturas que se sobrepõem é seguro — parcelas repetidas são puladas.',
    ...
    installment: (n: number, total: number) => `Parcela ${n}/${total}`,
    ...
    passwordPlaceholder: 'Senha do PDF (se protegido)',
    needsPassword: 'Este PDF precisa de senha para ser aberto',
    unsupportedPdf:
  ...
  newTransaction: {
    ...
    repeat: 'Repetir',
    repeatMonths: 'Repetir por quantos meses',
    notes: 'Observação',
    notesPlaceholder: 'Ex.: Parcela 2 de 6, combinado com fulano…',
