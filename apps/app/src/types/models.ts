...
export type CaptureOrigin = 'manual' | 'email' | 'telegram' | 'scanner' | 'aggregator';

export type BillCaptureStatus = 'pending' | 'confirmed' | 'rejected' | 'password_required';
...
export type BoletoPasswordRuleType = 'cpf_digits' | 'cnpj_digits' | 'birth_date' | 'fixed';
